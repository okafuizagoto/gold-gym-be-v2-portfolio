...
const (
	...
	qInsertCustomerType = `INSERT INTO u868654674_gold_gym_bez.customer_type
(ct_id, ct_gold_id, ct_code, ct_name, ct_category, ct_description, ct_status, ct_created_at, ct_updated_at)
VALUES %s`
)
