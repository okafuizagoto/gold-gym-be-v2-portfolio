...
const (
	...
	qInsertOutlet = `INSERT INTO outlet
(outlet_id, outlet_gold_id, outlet_code, outlet_name, outlet_address, outlet_status, created_at, updated_at) VALUES %s`
)

var (
	readStmt   = []statement{}
	insertStmt = []statement{
		// {insertoutlet, qInsertOutlet},
	}
