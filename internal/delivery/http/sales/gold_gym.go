...
type IgoldgymSvcSale interface {
	...
	SavePaymentProof(ctx context.Context, saleID string, originalName string, mimeType string, content []byte, uploadedBy string) (goldSaleEntity.PaymentProof, error)
